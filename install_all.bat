...
set VC_URL=https://github.com/broduer/visual-c-redistributable-runtimes-all-in-one/raw/refs/heads/main/visual-c-redistributable-runtimes-all-in-one_NOV_2022.zip
...
:: Find and execute `.bat` files in the subfolder "visual-c-redistributable-runtimes-all-in-one_NOV_2022"
set VC_SUBFOLDER=%VC_INSTALL_FOLDER%\visual-c-redistributable-runtimes-all-in-one_NOV_2022

echo Running .bat files for Visual C++ installation...
for %%F in ("%VC_SUBFOLDER%\*.bat") do (
